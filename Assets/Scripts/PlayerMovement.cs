...
public class PlayerMovement : MonoBehaviour  
{
    ...
    void FixedUpdate() {
        ...
        {
            transform.Rotate(new Vector3(Input.GetAxis("LeftJoystickX"), 0, 0) * Time.deltaTime * turnspeed);
            transform.Rotate(new Vector3(Input.GetAxis("LeftJoystickY"), 0, 0) * Time.deltaTime * turnspeed);
    ...
    void Update()  
    {
        ...
        if (Input.GetButton("A") || Input.GetKey("w"))
        {
            move = true;
        }
        else
        ...
        if (Input.GetButton("B") || Input.GetKey("s"))
        {
            reverse = true;
        }
        else
