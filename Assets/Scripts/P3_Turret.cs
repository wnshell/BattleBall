...
public class P3_Turret : MonoBehaviour {
	...
	void Start () {
		bulletOrigin = GameObject.Find ("BulletOrigin3").GetComponent<Transform>();
		mineOrigin = GameObject.Find ("MineOrigin3").GetComponent<Transform> ();
	}
	...
	void Update(){
		...
		float rotX = Input.GetAxis ("RightJoystickX_P3");
		float rotY = Input.GetAxis ("RightJoystickY_P3");
